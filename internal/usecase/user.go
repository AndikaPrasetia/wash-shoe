...
type UserUsecase interface {
	...
	Modify(ctx context.Context, u user.UpdateUserParams) (model.User, error)
...
func (uc *userUsecase) Modify(ctx context.Context, u user.UpdateUserParams) (model.User, error) {
